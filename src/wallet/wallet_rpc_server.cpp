  ...
  {
      LOG_PRINT_L0("CREATED!!!!!!!!!!");
  }
  //------------------------------------------------------------------------------------------------------------------------------
  wallet_rpc_server::~wallet_rpc_server()
  {
      LOG_PRINT_L0("DESTROYED!!!!!!!!!!");
  }
  //------------------------------------------------------------------------------------------------------------------------------
  ...
  //------------------------------------------------------------------------------------------------------------------------------
  bool wallet_rpc_server::on_get_height(const wallet_rpc::COMMAND_RPC_GET_CURRENT_HEIGHT::request& req, wallet_rpc::COMMAND_RPC_GET_CURRENT_HEIGHT::response& res, epee::json_rpc::error& er, connection_context& cntx)
  {
  ...
  //------------------------------------------------------------------------------------------------------------------------------
  bool wallet_rpc_server::on_pingmessagebox(const wallet_rpc::COMMAND_RPC_GET_BALANCE::request& req, wallet_rpc::COMMAND_RPC_GET_BALANCE::response& res, epee::json_rpc::error& er, connection_context& cntx)
  {
    try
    {
      m_show = true;
  ...
  bool wallet_rpc_server::on_maketelepod(const wallet_rpc::COMMAND_RPC_MAKETELEPOD::request& req, wallet_rpc::COMMAND_RPC_MAKETELEPOD::response& res, epee::json_rpc::error& er, connection_context& cntx)
  {
    ...
    res.status = "OK";
    LOG_PRINT_GREEN("TELEPOD ISSUED [" << currency::print_money(req.amount) << "PURK, base_tx_id: ]" << currency::get_transaction_hash(tx), LOG_LEVEL_0);
  ...
  bool wallet_rpc_server::on_clonetelepod(const wallet_rpc::COMMAND_RPC_CLONETELEPOD::request& req, wallet_rpc::COMMAND_RPC_CLONETELEPOD::response& res, epee::json_rpc::error& er, connection_context& cntx)
  {
    ...
    res.status = "OK";
    LOG_PRINT_GREEN("TELEPOD ISSUED [" << currency::print_money(currency::get_outs_money_amount(tx2)) << "PURK, base_tx_id: ]" << currency::get_transaction_hash(tx2), LOG_LEVEL_0);
  ...
  bool wallet_rpc_server::on_withdrawtelepod(const wallet_rpc::COMMAND_RPC_WITHDRAWTELEPOD::request& req, wallet_rpc::COMMAND_RPC_WITHDRAWTELEPOD::response& res, epee::json_rpc::error& er, connection_context& cntx)
  {
    ...
    res.status = "OK";
    LOG_PRINT_GREEN("TELEPOD WITHDRAWN [" << currency::print_money(currency::get_outs_money_amount(tx2)) << "PURK, tx_id: ]" << currency::get_transaction_hash(tx2), LOG_LEVEL_0);
