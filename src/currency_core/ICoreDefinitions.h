...
void serialize(BlockFullInfo&, CryptoNote::ISerializer&);
void serialize(TransactionPrefixInfo&, CryptoNote::ISerializer&);
void serialize(BlockShortInfo&, CryptoNote::ISerializer&);
